...
var EXIFExorcistPlugin = class extends import_obsidian.Plugin {
  ...
  async processImage(imageFile) {
    ...
    const subject = (_b = (_a = tags.xmp) == null ? void 0 : _a.subject) == null ? void 0 : _b.description;
    if (subject) {
  ...
  async reverseGeocode(lat, lon) {
    ...
    try {
      ...
      console.error(error);
      new import_obsidian.Notice("Reverse geocoding failed. See console for details.");
    }
...
`;
    for (const key of yamlOrder) {
      if (metadata[key] !== void 0) yaml += formatYamlLine(key, metadata[key]);
    }
    yaml += "---\n";
