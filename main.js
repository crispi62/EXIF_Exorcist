...
// main.ts
var EXIFExorcistPlugin = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    this.PLUGIN_VERSION = "DEBUG-V3";
  }
  async onload() {
    ...
    this.addRibbonIcon("image-file", "EXIF Exorcist: Read Metadata", async () => {
      ...
      if (!activeFile || activeFile.extension !== "jpg" && activeFile.extension !== "jpeg") {
        ...
        new import_obsidian.Notice("EXIF Exorcist: Please select a JPG or JPEG image file.");
        return;
      }
      try {
  ...
  async processImage(imageFile) {
    ...
    if (await this.app.vault.adapter.exists(notePath)) {
      new import_obsidian.Notice(`Sidecar note already exists at ${notePath}. Aborting.`);
      console.log(`EXIF Exorcist: Sidecar note already exists at ${notePath}. Aborting.`);
      return;
    }
    new import_obsidian.Notice(`[EXIF Exorcist v${this.PLUGIN_VERSION}] Step 1: Reading ${imageFile.name}`);
    ...
    if ((_b = (_a = tags.xmp) == null ? void 0 : _a.subject) == null ? void 0 : _b.description) {
      metadata.tags = tags.xmp.subject.description;
    }
    if (((_c = tags.gps) == null ? void 0 : _c.Latitude) && ((_d = tags.gps) == null ? void 0 : _d.Longitude)) {
      metadata.gpsLatitude = tags.gps.Latitude;
      metadata.gpsLongitude = tags.gps.Longitude;
    }
    if ((_f = (_e = tags.exif) == null ? void 0 : _e.DateTimeOriginal) == null ? void 0 : _f.description) {
    ...
    if ((_h = (_g = tags.exif) == null ? void 0 : _g.DateTime) == null ? void 0 : _h.description) {
    ...
    if ((_j = (_i = tags.exif) == null ? void 0 : _i.Model) == null ? void 0 : _j.description) {
      metadata.camera_model = tags.exif.Model.description;
    }
    if ((_l = (_k = tags.file) == null ? void 0 : _k.FileType) == null ? void 0 : _l.value) {
      metadata.file_type = tags.file.FileType.value;
    }
    if ((_n = (_m = tags.file) == null ? void 0 : _m["Image Height"]) == null ? void 0 : _n.description) {
      metadata.image_height = tags.file["Image Height"].description;
    }
    if ((_p = (_o = tags.file) == null ? void 0 : _o["Image Width"]) == null ? void 0 : _p.description) {
      metadata.image_width = tags.file["Image Width"].description;
    }
    metadata.image_description = ((_r = (_q = tags.exif) == null ? void 0 : _q.ImageDescription) == null ? void 0 : _r.description) || "";
  ...
  extractComment(tags) {
    ...
    const searchFields = [
      { name: "IPTC:Caption/Abstract", value: (_b = (_a = tags.iptc) == null ? void 0 : _a["Caption/Abstract"]) == null ? void 0 : _b.description },
      { name: "XMP:UserComment", value: (_d = (_c = tags.xmp) == null ? void 0 : _c.UserComment) == null ? void 0 : _d.description },
      { name: "XMP:Description", value: (_f = (_e = tags.xmp) == null ? void 0 : _e.description) == null ? void 0 : _f.description },
      { name: "EXIF:ImageDescription", value: (_h = (_g = tags.exif) == null ? void 0 : _g.ImageDescription) == null ? void 0 : _h.description }
    ];
    for (const field of searchFields) {
      if (field.value && typeof field.value === "string" && field.value.trim() !== "") {
        new import_obsidian.Notice(`[EXIF Exorcist v${this.PLUGIN_VERSION}] Found text in ${field.name}!`);
        console.log(`EXIF Exorcist: Found text in ${field.name}: "${field.value}"`);
        return field.value;
      }
    }
    const userCommentValue = (_j = (_i = tags.exif) == null ? void 0 : _i.UserComment) == null ? void 0 : _j.value;
    if (Array.isArray(userCommentValue) && userCommentValue.length > 8) {
      ...
      if (decodedComment) {
        new import_obsidian.Notice(`[EXIF Exorcist v${this.PLUGIN_VERSION}] Found text in EXIF:UserComment!`);
        console.log(`EXIF Exorcist: Found text in EXIF:UserComment: "${decodedComment}"`);
        return decodedComment;
      }
    }
    new import_obsidian.Notice(`[EXIF Exorcist v${this.PLUGIN_VERSION}] No caption or comment found.`);
    return "";
  }
  async createSidecarNote(imageFile, metadata, comment) {
    ...
    const formatYamlLine = (key, value) => {
...
`;
    for (const key of yamlOrder) {
      ...
      else if (metadata[key] !== void 0) yaml += formatYamlLine(key, metadata[key]);
    }
    yaml += "---\n";
...
`;
    ...
    new import_obsidian.Notice(`EXIF Exorcist: Created sidecar note at ${notePath}`);
  }
  onunload() {
